  ...
  return (
    <section className="dark:bg-gray-100 dark:text-gray-800">
      <div className="container max-w-xl p-6 py-12 mx-auto lg:px-8 lg:max-w-7xl">
        <div>
          <h2 className="text-3xl pt-6 md:pt-24 font-bold tracking-tight text-center sm:text-5xl dark:text-gray-900">
            ROADMAP
          </h2>
        </div>
            ...
            <div className=":pt-12 p-6 bg-gray-200  space-y-12">
              <div className="flex">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center w-12 h-12 rounded-md  text-gray-800">
                    1{" "}
                    <Image
                      className="mx-auto rounded-lg shadow-lg dark:bg-gray-500 md:h-full"
                      src={america}
                      alt="Nikula Tisla"
                      width={36}
                      height={36}
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 dark:text-gray-600">• TBA</p>
                  <p className="mt-2 dark:text-gray-600">• TBA</p>
                </div>
              </div>
            </div>
